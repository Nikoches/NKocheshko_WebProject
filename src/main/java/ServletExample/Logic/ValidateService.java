...
public class ValidateService implements Validate {
    ...
    */
    ...
    private Function<User, Optional> getCities() {
        return key -> Optional.of(usersStorage.getCities());
    }

    public User processUser(List<FileItem> items)  {
